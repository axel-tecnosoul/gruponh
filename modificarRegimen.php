            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
				  ...
				  <form class="form theme-form" role="form" method="post" action="modificarRegimen.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						...
						<a onclick="document.location.href='listarRegimenes.php'" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
