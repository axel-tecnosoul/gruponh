<?php
    ...
    if (!empty($_POST)) {
		...
		if (!empty($_POST['btn2'])) {
			...
			header("Location: nuevaTareaTarea.php?id=".$_POST['id_proyecto']);
		}
    }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
				...
				<form class="form theme-form" role="form" method="post" action="nuevaTareaTarea.php">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						...
						<a href="listarTareas.php" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
