...
<div class="page-sidebar">
	...
	<div class="sidebar custom-scrollbar">
		<ul class="sidebar-menu">
			...
			<?php if(tienePermiso(272)||tienePermiso(276)||tienePermiso(390)){ ?><li <?php abrirMenu(2);?>><a class="sidebar-header" href="#"><i data-feather="file-text"></i><span>Proyectos</span><i class="fa fa-angle-right pull-right"></i></a>
			...
			<?php if(tienePermiso(259)||tienePermiso(391)||tienePermiso(263)||tienePermiso(335)||tienePermiso(367)||tienePermiso(369)||tienePermiso(373)||tienePermiso(379)||tienePermiso(386)){ ?><li <?php abrirMenu(3);?>><a class="sidebar-header" href="#"><i data-feather="cloud-lightning"></i><span>Administración</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
				...
				<?php if(tienePermiso(259)||tienePermiso(391)||tienePermiso(263)||tienePermiso(335)||tienePermiso(367)||tienePermiso(369)||tienePermiso(373)||tienePermiso(379)||tienePermiso(386)){?><li><a href="listarSucesos.php"><i class="fa fa-circle"></i>Sucesos</a></li><?php }?>
				...
				<?php if(tienePermiso(259)||tienePermiso(391)||tienePermiso(263)||tienePermiso(335)||tienePermiso(367)||tienePermiso(369)||tienePermiso(373)||tienePermiso(379)||tienePermiso(386)){?><li><a href="listarConceptosContables.php"><i class="fa fa-circle"></i>Conceptos Contables</a></li><?php }?>
				</ul>
			</li><?php }?>
			
      <?php if(tienePermiso(267)){ ?><li <?php abrirMenu(4);?>><a class="sidebar-header" href="#"><i data-feather="shopping-bag"></i><span>Comercial</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
				<?php if(tienePermiso(267)){?><li><a href="listarPresupuestos.php"><i class="fa fa-circle"></i>Presupuestos</a></li><?php }?>
				</ul>
			</li><?php }?>
			<?php if(tienePermiso(285)||tienePermiso(296)||tienePermiso(297)||tienePermiso(308)||tienePermiso(334)){ ?><li <?php abrirMenu(5);?>><a class="sidebar-header" href="#"><i data-feather="flag"></i><span>Compras</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
			...
			<?php if(tienePermiso(308)||tienePermiso(309)||tienePermiso(314)||tienePermiso(289)||tienePermiso(313)||tienePermiso(347)){ ?><li <?php abrirMenu(6);?>><a class="sidebar-header" href="#"><i data-feather="layout"></i><span>Producción</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
				<?php if(tienePermiso(308)){?><li><a href="listarIngresos.php"><i class="fa fa-circle"></i>Ingresos</a></li><?php }?>
			...
			<?php if(tienePermiso(280)||tienePermiso(289)||tienePermiso(314)||tienePermiso(347)){ ?><li <?php abrirMenu(7);?>><a class="sidebar-header" href="#"><i data-feather="send"></i><span>Ingeniería</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
			...
			<?php if(tienePermiso(357)){ ?><li <?php abrirMenu(8);?>><a class="sidebar-header" href="#"><i data-feather="truck"></i><span>Logística</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
				<?php if(tienePermiso(357)){?><li><a href="listarDespachos.php"><i class="fa fa-circle"></i>Despachos</a></li><?php }?>
				</ul>
			</li><?php }?>
			<?php if(tienePermiso(1)||tienePermiso(2)||tienePermiso(3)){ ?><li <?php abrirMenu(9);?>><a class="sidebar-header" href="#"><i data-feather="lock"></i><span>Seguridad</span><i class="fa fa-angle-right pull-right"></i></a>
			...
			<?php if(tienePermiso(13)||tienePermiso(326)){ ?><li <?php abrirMenu(10);?>><a class="sidebar-header" href="#"><i data-feather="settings"></i><span>Configuración</span><i class="fa fa-angle-right pull-right"></i></a>
				<ul class="sidebar-submenu">
					<?php
