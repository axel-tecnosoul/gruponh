                ...
                <div class="card">
                  <div class="card-header">
                    <h5><?php echo $ubicacion;
                      if (!empty(tienePermiso(286))) { ?>
                        <a href="nuevoMaterial.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo" title="Nuevo"></a>&nbsp;&nbsp;<?php
                      } ?>
                      ...
                      <a href="#" id="link_ver_material"><img src="img/eye.png" width="24" height="15" border="0" alt="Ver" title="Ver"></a>&nbsp;&nbsp;<?php
                      ...
                      if (!empty(tienePermiso(300))) {?>
                        <a href="#" id="link_ver_precios_material"><img src="img/dolar.png" width="24" height="25" border="0" alt="Histórico de Precios" title="Histórico de Precios"></a>&nbsp;&nbsp;<?php
                      }
