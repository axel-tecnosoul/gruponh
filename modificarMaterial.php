<?php
    ...
    if (!empty($_POST)) {
        ...
        $sql = "UPDATE `materiales` set `codigo` = ?, `concepto` = ?, `calidad` = ?, `descripcion` = ?, `largo` = ?, `peso_metro` = ?, `id_categoria` = ?, `activo` = ?, `id_unidad_medida` = ?, `stock_minimo` = ? where id = ?";
        $q = $pdo->prepare($sql);
        $q->execute([$_POST['codigo'],$_POST['concepto'],$_POST['calidad'],$_POST['descripcion'],$_POST['largo'],$_POST['peso_metro'],$_POST['id_categoria'],$_POST['activo'],$_POST['id_unidad_medida'],$_POST['stock_minimo'],$_GET['id']]);
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
							...
							<div class="col-sm-9">
							<select name="id_categoria" id="id_categoria" class="js-example-basic-single col-sm-12" autofocus required="required">
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9">
								<input name="largo" type="number" step="0.01" class="form-control" required="required" value="<?php echo $data['largo']; ?>">
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9">
								<input name="peso_metro" type="number" step="0.01" class="form-control" required="required" value="<?php echo $data['peso_metro']; ?>">
