<?php
    ...
    if (!empty($_POST)) {
        ...
        $q = $pdo->prepare($sql);
        $q->execute([$_POST['largo'],$_POST['ancho'],$_POST['marca'],$_POST['peso'],$_POST['finalizado'],$_POST['diametro'],$_POST['calidad'],$_GET['id']]);
    ...
    <div class="page-wrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="page-body"><?php
          $ubicacion="Modificar Posición de Conjunto";
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
				  ...
				  <form class="form theme-form" role="form" method="post" action="modificarPosicionConjuntoListaCorte.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
						<div class="col">
						...
						<div class="col-sm-9">
						<select name="id_material" id="id_material" class="js-example-basic-single col-sm-12" autofocus disabled="disabled">
						...
						<div class="form-group row">
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9"><input name="largo" type="number" step="0.01" class="form-control" value="<?php echo $data['largo']; ?>"></div>
						  </div>
						  <div class="form-group row">
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9"><input name="diametro" type="number" step="0.01" class="form-control" value="<?php echo $data['diametro']; ?>"></div>
						  </div>
						  <div class="form-group row">
							...
							<div class="col-sm-9"><input name="marca" type="text" maxlength="99" class="form-control" value="<?php echo $data['marca']; ?>"></div>
						  </div>
						  <div class="form-group row">
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9">
							<select name="finalizado" id="finalizado" class="js-example-basic-single col-sm-12" required="required">
							<option value="">Seleccione...</option>
