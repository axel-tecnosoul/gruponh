        ...
        <div class="page-body"><?php
          ...
          <div class="container-fluid">
			...
			<div class="col-md-12">
				<div class="card">
				  <div class="card-body">
					<form class="form-inline theme-form mt-3" name="form1" method="post" action="listarProyectos.php">
					  ...
					  <div class="form-group mb-0">
						<button class="btn btn-primary" onclick="document.form1.target='_self';document.form1.action='listarProyectos.php'">Buscar</button>
					  </div>
					</form>
				</div>
			  </div>
