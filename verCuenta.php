<?php
    ...
    if (!empty($_POST)) {
        ...
        $sql = "SELECT `id`, `id_tipo_cuenta`, `nombre`, `razon_social`, `cuit`, `contacto`, `email`, `telefono`, `id_puesto`, `codigo_postal`, `id_pais`, `id_provincia`, `id_localidad`, `observaciones`, `activo`, `es_recurso`, `anulado`, `cuenta_gestion`, `codigo_externo`, `id_condicion_iva`, `direccion` FROM `cuentas` WHERE id = ? ";
        $q = $pdo->prepare($sql);
        $q->execute([$id]);
          ...
          <form class="form theme-form" role="form" method="post" action="#">
                    <div class="card-body">
                      <div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
							<select name="id_tipo_cuenta" id="id_tipo_cuenta" class="js-example-basic-single col-sm-12" required="required">
							...
							<div class="col-sm-9"><input name="telefono" type="text" maxlength="99" class="form-control" required="required" value="<?php echo $data['telefono']; ?>"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Puesto</label>
							<div class="col-sm-9">
							<select name="id_puesto" id="id_puesto" class="js-example-basic-single col-sm-12" required="required">
							<option value="">Seleccione...</option>
							<?php
							$pdo = Database::connect();
							$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
							...
							<div class="col-sm-9"><input name="direccion" type="text" maxlength="99" class="form-control" value="<?php echo $data['direccion']; ?>"></div>
							</div>
							<div class="form-group row">
							...
							<div class="col-sm-9">
							<select name="es_recurso" id="es_recurso" class="js-example-basic-single col-sm-12" required="required">
							<option value="">Seleccione...</option>
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
                        <a href="#" onclick="document.location.href='listarCuentas.php'" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
