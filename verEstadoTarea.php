                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
							...
							<div class="col-sm-9">
							<select name="id_cuenta_recurso" id="id_cuenta_recurso" class="js-example-basic-single col-sm-12" disabled="disabled">
							<option value="">Seleccione...</option>
							<?php
							$pdo = Database::connect();
							$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
							...
							<div class="col-sm-9"><input name="fecha_inicio_prevista" type="date" onfocus="this.showPicker()" class="form-control" value="<?php echo $data['fecha_inicio_prevista']; ?>" readonly="readonly"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">F.F.P</label>
							<div class="col-sm-9"><input name="fecha_fin_prevista" type="date" onfocus="this.showPicker()" class="form-control" value="<?php echo $data['fecha_fin_prevista']; ?>" readonly="readonly"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">F.I.R</label>
							<div class="col-sm-9"><input name="fecha_inicio_real" type="date" onfocus="this.showPicker()" class="form-control" value="<?php echo $data['fecha_inicio_real']; ?>" readonly="readonly"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">F.F.R</label>
							<div class="col-sm-9"><input name="fecha_fin_real" type="date" onfocus="this.showPicker()" class="form-control" value="<?php echo $data['fecha_fin_real']; ?>" readonly="readonly"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Comentarios de Inicio</label>
							<div class="col-sm-9"><textarea name="comentarios_inicio" maxlength="199" class="form-control" disabled="disabled"><?php echo $data['comentarios_inicio']; ?></textarea></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Comentarios de Fin</label>
							<div class="col-sm-9"><textarea name="comentarios_fin" maxlength="199" class="form-control" disabled="disabled"><?php echo $data['comentarios_fin']; ?></textarea></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">¿Presentado?</label>
							<div class="col-sm-9">
							<select name="presentado" id="presentado" class="js-example-basic-single col-sm-12" disabled="disabled">
							<option value="">Seleccione...</option>
							...
							<div class="col-sm-9">
							<select name="verificado" id="verificado" class="js-example-basic-single col-sm-12" disabled="disabled">
							<option value="">Seleccione...</option>
							...
							<div class="col-sm-9">
							<select name="aprobado_cliente" id="aprobado_cliente" class="js-example-basic-single col-sm-12" disabled="disabled">
							<option value="">Seleccione...</option>
