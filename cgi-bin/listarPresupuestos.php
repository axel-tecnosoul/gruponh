                  ...
                  <div class="card-header">
                    <h5><?php echo $ubicacion;
                      ...
                      if (!empty(tienePermiso(269))) {
                        echo '<a href="#" id="link_modificar_presupuesto"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Modificar/Revisar" title="Modificar/Revisar"></a>';
                        echo '&nbsp;&nbsp;';
                    ...
                    <div class="dt-ext table-responsive">
                      <table class="display truncate" id="dataTables-example666">
                        ...
                        <tbody><?php
                            ...
                            $sql = " SELECT p.id, p.nro, p.nro_revision, date_format(p.fecha,'%d/%m/%y') AS fecha, c.nombre, p.solicitante, p.referencia, p.descripcion, m.moneda, p.monto, p.adjudicado FROM presupuestos p inner join cuentas c on c.id = p.id_cuenta inner join monedas m on m.id = p.id_moneda WHERE p.anulado = 0 ";
    ...
    <script>
      $(document).ready(function() {
		...
		$("#link_adjudicar_presupuesto").on("click",function(){
          let l=document.location.href;
          if(this.href==l || this.href==l+"#"){
            alert("Por favor un presupuesto en su última revisión para adjudicar")
          }
        })
        ...
        $("#link_eliminar_presupuesto").on("click",function(){
          ...
          let target=this.dataset.target;
          if(target==undefined || target=="#"){
            alert("Por favor seleccione un presupuesto para eliminar")
          }
        })	  
        ...
        $(document).on("click","#dataTables-example666 tbody tr td", function(){
          ...
          if(t.hasClass('selected')){
			...
			$("#link_adjudicar_presupuesto").attr("href","adjudicarPresupuesto.php?id="+id_presupuesto+"&revision="+nro_revision);
