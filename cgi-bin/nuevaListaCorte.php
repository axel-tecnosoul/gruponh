...
if (!empty($_POST)) {
  ...
  $sql = "SELECT count(id) cant FROM listas_corte_revisiones where id_proyecto = ?";
  $q = $pdo->prepare($sql);
  ...
  $q = $pdo->prepare($sql);
  $q->execute([$id_lista_corte,$_POST['id_proyecto'],$_POST['fecha'],$_SESSION['user']['id'],$_POST['nombre'],$_POST['numero'],"Emisión original"]);
  ...
  $q->execute(array($_SESSION['user']['id']));
	...
	$titulo = "ERP Notificaciones - Módulo Ingeniería - Nueva Lista de Corte";
