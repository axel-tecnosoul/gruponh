    ...
    <div class="page-wrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="page-body"><?php
          $ubicacion="Modificar Orden de Trabajo";
          include_once("head_page.php")?>
          <!-- Container-fluid starts-->
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                <form class="form theme-form" role="form" method="post" action="modificarOrdenTrabajo.php?id=<?=$_GET['id']?>">
                  <div class="card mb-0">
                  ...
                  <div class="card mb-0">
                    ...
                    <div class="card-footer">
                      <div class="col-12">
                        ...
                        <!--<button type="submit" value="2" name="btn2" class="btn btn-success">Revisar</button>-->
