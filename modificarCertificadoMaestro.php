...
if (!empty($_POST)) {
  ...
  $sql = "UPDATE certificados_maestros SET id_occ=?, numero=?, fecha_emision=?, fecha_inicio=?, fecha_fin=?, id_moneda=?, cotizacion_dolar=?, monto_total=?, observaciones=? WHERE id = ?";
  $q = $pdo->prepare($sql);
  $q->execute([
  $_POST["id_occ"], $_POST["numero"], $_POST["fecha_emision"], $_POST["fecha_inicio"], $_POST["fecha_fin"], $_POST["id_moneda"], $_POST["cotizacion_dolar"], $_POST["monto_total"], $_POST["observaciones"],$id]);
  ...
  if(isset($_POST['btn1'])){
    ...
    $redirect="nuevoCertificadoMaestroDetalle.php?id_certificado_maestro=".$id;
  }
  ...
  $pdo = Database::connect();
  $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
  $sql = "SELECT numero,id_occ,fecha_emision,fecha_inicio,fecha_fin,id_moneda,cotizacion_dolar,monto_total,observaciones FROM certificados_maestros WHERE id = ?";
  $q = $pdo->prepare($sql);
  $q->execute([$id]);
      ...
      <div class="page-body-wrapper">
       <?php include('menu.php');?>
        ...
        <div class="page-body"><?php
          $ubicacion="Modificar Certificado Maestro";
                ...
                <div class="card">
                  <div class="card-header">
                    <h5><?=$ubicacion?></h5>
					        ...
					        <form class="form theme-form" role="form" method="post" action="modificarCertificadoMaestro.php?id=<?=$id?>" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9"><input name="fecha_emision" type="date" onfocus="this.showPicker()" class="form-control" required="required" value="<?=$data['fecha_emision'];?>"></div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9"><input name="cotizacion_dolar" type="number" min="0" step="0.01" class="form-control" value="<?=$data['cotizacion_dolar'];?>"></div>
                          </div>
                          <div class="form-group row">
