                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                            ...
                            <div class="col-sm-9">
                              <select name="id_sitio" id="id_sitio" class="js-example-basic-single col-sm-12" required="required">
                                ...
                                while ($fila = $q->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  <option value='<?=$fila['id']?>'  <?=$selected?>><?=$fila['nombre'].' ('.$fila['nro_sitio'].' / '.$fila['nro_subsitio'].')'?></option><?php
                                }
                                Database::disconnect();?>
                              </select>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input name="nombre" type="text" maxlength="99" class="form-control" required="required" value="<?php echo $data['nombre']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Descripción</label>
                            <div class="col-sm-9">
                              <input name="descripcion" type="text" maxlength="99" class="form-control" required="required" value="<?php echo $data['descripcion']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="id_cliente" id="id_cliente" class="js-example-basic-single col-sm-12" required="required">
                                ...
                                while ($fila = $q->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  <option value='<?=$fila['id']?>'<?=$selected?>><?=$fila['nombre']?></option><?php
                                }
                                Database::disconnect();?>
                              </select>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input name="solicitante" type="text" maxlength="99" class="form-control" required="required" value="<?php echo $data['solicitante']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Información_de Entrada</label>
                            <div class="col-sm-9">
                              <textarea name="informacion_entrada" class="form-control"><?php echo $data['informacion_entrada']; ?></textarea>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Fecha Pedido</label>
                            <div class="col-sm-9">
                              <input name="fecha_pedido" type="date" onfocus="this.showPicker()" maxlength="99" class="form-control" required="required" value="<?php echo $data['fecha_pedido']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Fecha Entrega</label>
                            <div class="col-sm-9">
                              <input name="fecha_entrega" type="date" onfocus="this.showPicker()" maxlength="99" class="form-control" value="<?php echo $data['fecha_entrega']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="id_linea_negocio" id="id_linea_negocio" class="js-example-basic-single col-sm-12" required="required">
                                ...
                                while ($fila = $q->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  <option value='<?=$fila['id']?>' <?=$selected?>><?=$fila['linea_negocio']?></option><?php
                                }
                                Database::disconnect();?>
                              </select>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input name="tags" type="text" maxlength="299" class="form-control" required="required" value="<?php echo $data['tags']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="id_tipo_proyecto" id="id_tipo_proyecto" class="js-example-basic-single col-sm-12" required="required">
                                ...
                                while ($fila = $q->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  <option value='<?=$fila['id']?>' <?=$selected?>><?=$fila['tipo']?></option><?php
                                }
                                Database::disconnect();?>
                              </select>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea name="observaciones" class="form-control"><?=$data['observaciones']; ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <h5 class="mb-5 font-weight-bold">Sucesos del Proyecto</h5>
                          <div class="timeline-small mb-4"><?php 
                            $sql_sucesos = "SELECT s.id, DATE_FORMAT(s.fecha_hora,'%d/%m/%y %H:%i') AS fecha_formateada, s.suceso, s.titulo, ts.tipo, u.usuario AS nombre_usuario
                            FROM sucesos s 
                      ...
                      <div class="row">
                        <div class="col">
                          <h5 class="mb-5 font-weight-bold">Adjuntos</h5>
                          <table class="display" id="dataTables-example667">
                            ...
                            <tbody><?php
                              ...
                              foreach ($pdo->query($sql) as $row) {?>
                                <tr>
                                  <td><?=$row[1]?></td>
                                  <td><a target="_blank" href="<?=$row[2]?>">Descargar</a></td>
                                </tr><?php
                              }
                              Database::disconnect();?>
                            </tbody>
                      ...
                      <div class="row">
                        <div class="col">
                          <h5 class="mb-5 font-weight-bold">Presupuestos</h5>
                          <table class="display" id="dataTables-example668">
                            ...
                            <tbody><?php
                              $pdo = Database::connect();
                              $sql = " SELECT p.nro, date_format(p.fecha,'%d/%m/%y') AS fecha_formatted, p.nro_revision, c.nombre, p.solicitante, p.referencia, p.descripcion, m.moneda, p.monto, p.adjudicado,date_format(p.fecha,'%Y') AS anio,pp.id FROM proyectos_presupuestos pp inner join presupuestos p on p.id = pp.id_presupuesto inner join cuentas c on c.id = p.id_cuenta inner join monedas m on m.id = p.id_moneda WHERE p.anulado = 0 and pp.id_proyecto = ".$_GET['id'];
                              foreach ($pdo->query($sql) as $row) {
                                $adjudicado="No";
                                if ($row["adjudicado"] == 1) {
                                  $adjudicado="Si";
                                ...
                                <tr>
                                  <td><?=$row["nro"].' / '.$row["nro_revision"]?></td>
                                  <td><?=$row["fecha_formatted"]?></td>
                                  <td><?=$row["nombre"]?></td>
                                  <td><?=$row["solicitante"]?></td>
                                  <td><?=$row["referencia"]?></td>
                                  <td><?=$row["descripcion"]?></td>
                                  <td><?=$row["moneda"] . ' ' . number_format($row["monto"],2)?></td>
                                  <td><?=$adjudicado?></td>
                                </tr><?php
                              }
                              Database::disconnect();?>
                      ...
                      <div class="row">
                        <div class="col">
                          <h5 class="mb-5 font-weight-bold">Mapa</h5>
