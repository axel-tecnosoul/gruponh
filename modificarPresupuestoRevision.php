                  ...
                  <div class="card-header">
                      ...
                      <div class="row">
                        <div class="col">
						  ...
						  <div class="form-group row">
                            ...
                            <div class="col-sm-9"><textarea name="comentarios_revision" class="form-control" required="required"></textarea></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						...
						?>
                        <button type="submit" value="2" name="btn2" class="btn btn-success">Revisión</button>
                        <?php } ?>
