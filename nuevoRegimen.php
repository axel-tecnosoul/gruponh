  ...
  <body>
    ...
    <?php include('menu.php');?>
        ...
        <div class="page-body"><?php
          ...
          <form class="form theme-form" role="form" method="post" action="nuevoRegimen.php">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
            ...
            <a href="listarRegimenes.php" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
