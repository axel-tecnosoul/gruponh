            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
				  ...
				  <form class="form theme-form" role="form" method="post" action="nuevoSuceso.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
					...
					<input type="hidden" name="desdePedidos" value="<?php if (!empty($_GET['desdePedidos'])) echo "1"; else echo "0"; ?>" />
                  </form>
                </div>
              </div>
            </div>
