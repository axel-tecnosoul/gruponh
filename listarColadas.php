                ...
                <div class="card">
                  <div class="card-header">
                    <h5><?php echo $ubicacion; ?>
                      <a href="exportColadas.php"><img src="img/xls.png" width="24" height="25" border="0" alt="Exportar" title="Exportar"></a>&nbsp;&nbsp;<?php 
                      if (!empty(tienePermiso(325))) {?>
                        <a href="nuevaColadaOrigen.php" id="btnNuevaColadaOrigen"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nueva Colada de Origen" title="Nueva Colada de Origen"></a>&nbsp;&nbsp;
                        <a href="#" id="link_modificar_colada"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Actualizar Colada" title="Actualizar Colada"></a>&nbsp;&nbsp;<?php
                      }?>
					          </h5>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody><?php
                          ...
                          foreach ($pdo->query($sql) as $row) {?>
                            <tr>
                              ...
                              <td><?=$row["nombre"]?></td>
                              <td><?=$row["nro_oc"]?></td>
                              <td><?=$row["cod_fabricante"]?></td>
                              <td><?=$row["nro_colada"]?></td>
                              <td><?=$row["nro_colada_interna"]?></td>
                            </tr><?php
                          }
                          Database::disconnect();?>
                        </tbody>
