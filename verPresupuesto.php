          ...
          <form class="form theme-form" role="form" method="post" action="#">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						<a class="btn btn-primary" target="_blank" href="imprimirPresupuesto.php?id=<?php echo $data['id']; ?>">Imprimir</a>
                        <a href="#" onclick="document.location.href='listarPresupuestos.php'" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
