                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="largo" type="number" step="0.01" class="form-control">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="peso_metro" type="number" step="0.01" class="form-control">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9"><input name="stock_minimo" type="number" step="0.01" class="form-control"></div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Perímetro (mm)</label>
                          <div class="col-sm-9">
                            <input name="perimetro" type="number" step="0.01" class="form-control">
