...
<head>
  ...
  <style>
    ...
    #modalConfirmacion .modal-header.bg-primary {
      background-color: #007bff !important;
    }

    #modalConfirmacion .modal-header.bg-warning {
      background-color: #ffc107 !important;
    }

    #modalConfirmacion .modal-header.bg-success {
      background-color: #28a745 !important;
    }

    #modalRemitos .modal-header.bg-info {
                      ...
                      <?php if (tienePermiso(305)) { ?>
                        <div class="form-group mb-3">
                          ...
                          <button type="button" class="btn btn-success btn-lg py-4 border"
                            ...
                            <i class="fa fa-building mr-1"></i> Entrega en obra
                          </button>
                        </div>
                      <?php } ?>
                      &nbsp;
  ...
  <script>
    ...
    (function() {
      ...
      input.addEventListener('blur', function(e) {
        ...
        if (val !== '') {
          e.target.value = formatearRemito(val);
        }
      });
      ...
      input.addEventListener('focus', function(e) {
        ...
        var partes = val.split('-');
        if (partes.length === 2) {
          e.target.value = parseInt(partes[0], 10) + '-' + parseInt(partes[1], 10);
        }
      });
    })();
