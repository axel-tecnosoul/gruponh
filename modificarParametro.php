<?php
    ...
    if (!empty($_POST)) {
		...
		$sql = "INSERT INTO logs(`fecha_hora`, `id_usuario`, `detalle_accion`,`modulo`,link) VALUES (now(),?,'Modificación de parámetro del sistema ID #$id','Parámetros','')";
		$q = $pdo->prepare($sql);
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9"><input name="parametro" type="text" autofocus class="form-control" value="<?php echo $data['parametro']; ?>" readonly></div>
                          </div>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Valor</label>
                            <div class="col-sm-9"><textarea name="valor" class="form-control" required="required" rows="5"><?php echo $data['valor']; ?></textarea></div>
                          </div>
