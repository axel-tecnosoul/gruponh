<?php
    ...
    if (!empty($_POST)) {
        ...
        $sql = "UPDATE `listas_corte_detalle` set `id_estado_detalle_lista_corte` = ? where id = ?";
        $q = $pdo->prepare($sql);
        $q->execute([$_POST['id_estado_detalle_lista_corte'],$_GET['id']]);

		$sql = "INSERT INTO logs(`fecha_hora`, `id_usuario`, `detalle_accion`,`modulo`,link) VALUES (now(),?,'Modificación de detalle de lista de corte','Listas de Corte','imprimirListaCorte.php?id=$id')";
		$q = $pdo->prepare($sql);
  ...
  <body>
    ...
    <?php include('menu.php');?>
        ...
        <div class="page-body"><?php
          $ubicacion="Modificar Item de Lista de Corte";
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
					...
					<form class="form theme-form" role="form" method="post" action="modificarDetalleItemListaCorte.php?id=<?php echo $id;?>&idLC=<?php echo $_GET['idLC'];?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
							...
							<div class="col-sm-9">
							<select name="id_material" id="id_material" autofocus class="js-example-basic-single col-sm-12" disabled="disabled">
							...
							<div class="col-sm-9">
							<select name="id_estado_detalle_lista_corte" id="id_estado_detalle_lista_corte" class="js-example-basic-single col-sm-12" required="required">
							<option value="">Seleccione...</option>
							<?php
							$pdo = Database::connect();
							$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
