  ...
  <body>
    ...
    <?php include('menu.php');?>
        ...
        <div class="page-body"><?php
          $ubicacion="Nuevo Estado de Tarea";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
				...
				<form class="form theme-form" role="form" method="post" action="nuevoEstadoTarea.php">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
							...
							<div class="col-sm-9"><input name="fecha_inicio_prevista" id="fecha_inicio_prevista" type="date" onfocus="this.showPicker()" class="form-control"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">F.F.P</label>
							<div class="col-sm-9"><input name="fecha_fin_prevista" id="fecha_fin_prevista" type="date" onfocus="this.showPicker()" class="form-control"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">F.I.R</label>
							<div class="col-sm-9"><input name="fecha_inicio_real" id="fecha_inicio_real" type="date" onfocus="this.showPicker()" class="form-control" ></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">F.F.R</label>
							<div class="col-sm-9"><input name="fecha_fin_real" id="fecha_fin_real" type="date" onfocus="this.showPicker()" class="form-control" ></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Comentarios de Inicio</label>
							<div class="col-sm-9"><textarea name="comentarios_inicio" maxlength="199" class="form-control" ></textarea></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Comentarios de Fin</label>
							<div class="col-sm-9"><textarea name="comentarios_fin" maxlength="199" class="form-control" ></textarea></div>
							</div>
							<div class="form-group row">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						...
						<a href="listarEstadosTareas.php" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
