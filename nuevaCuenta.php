<?php
    ...
    if (!empty($_POST)) {
		...
		$q = $pdo->prepare($sql);
		$q->execute([$_POST['id_tipo_cuenta'],$_POST['nombre'],$_POST['razon_social'],$_POST['cuit'],$_POST['contacto'],$_POST['email'],$_POST['telefono'],$_POST['id_puesto'],$_POST['codigo_postal'],$_POST['id_pais'],$_POST['id_provincia'],$_POST['id_localidad'],$_POST['observaciones'],$_POST['es_recurso'],$_POST['cuenta_gestion'],$_POST['codigo_externo'],$_POST['id_condicion_iva'],$_POST['direccion'],$_POST['id_usuario']]);
        
		$sql = "INSERT INTO logs(`fecha_hora`, `id_usuario`, `detalle_accion`,`modulo`,link) VALUES (now(),?,'Nueva Cuenta agregada al sistema','Cuentas','verCuenta.php?id=$id')";
		$q = $pdo->prepare($sql);
		...
		if ($_POST['nuevoPresupuesto'] == 1) {
			header("Location: nuevoPresupuesto.php");	
		} else if ($_POST['nuevoProyecto'] == 1) {
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
				...
				<form class="form theme-form" role="form" method="post" action="nuevaCuenta.php">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
							...
							<div class="col-sm-9">
							<select name="id_tipo_cuenta" id="id_tipo_cuenta" class="js-example-basic-single col-sm-12" autofocus required="required">
							...
							<div class="col-sm-9"><input name="razon_social" type="text" maxlength="99" class="form-control" required="required"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">CUIT / CUIL(*)</label>
							<div class="col-sm-9"><input name="cuit" type="text" maxlength="99" class="form-control" required="required"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Contacto</label>
							<div class="col-sm-9"><input name="contacto" type="text" maxlength="99" class="form-control"></div>
							</div>
							<div class="form-group row">
							...
							<div class="col-sm-9"><input name="telefono" type="text" maxlength="99" class="form-control"></div>
							</div>
							<div class="form-group row">
							...
							<div class="col-sm-9"><input name="direccion" type="text" maxlength="199" class="form-control"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Código Postal</label>
							<div class="col-sm-9"><input name="codigo_postal" type="text" maxlength="99" class="form-control"></div>
							</div>
							<div class="form-group row">
							...
							<div class="col-sm-9"><input name="cuenta_gestion" type="text" maxlength="99" class="form-control"></div>
							</div>
							<div class="form-group row">
							<label class="col-sm-3 col-form-label">Código Externo</label>
							<div class="col-sm-9"><input name="codigo_externo" type="text" maxlength="99" class="form-control"></div>
							</div>
							<div class="form-group row">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						...
						<a href="listarCuentas.php" class="btn btn-light">Volver</a>
                      </div>
                    </div>
					<input type="hidden" name="nuevoPresupuesto" value="<?php if (!empty($_GET['nuevoPresupuesto'])) echo "1"; else echo "0"; ?>" />
                  </form>
                </div>
              </div>
            </div>
